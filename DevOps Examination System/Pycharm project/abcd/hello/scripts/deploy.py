...
def create_deployment(api_instance, deployment,newnamespace):
    # Create deployement
...
def createNamespace(name1):
    config.load_kube_config()
    v1 = client.CoreV1Api()
    body = client.V1Namespace()
    body.metadata = client.V1ObjectMeta(name=name1)

    # print(v1.list_namespace())
    v1.create_namespace(body)

def deploy(name,count):
    ...
    create_deployment(extensions_v1beta1, deployment,name)
