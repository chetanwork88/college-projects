...
$result = mysqli_query($connString, "SELECT sno,material,quantity,agency,fname,lname,intime,outime FROM details WHERE date1='$inputdate'") or die("database error:". mysqli_error($connString));
