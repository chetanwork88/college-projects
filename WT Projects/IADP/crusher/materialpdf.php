...
$result = mysqli_query($connString, "SELECT sno,agency,quantity,fname,mname,lname,pass FROM crusherdetails WHERE material='$inputmaterial'") or die("database error:". mysqli_error($connString));
