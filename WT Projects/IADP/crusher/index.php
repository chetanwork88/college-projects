    ...
    <table>
    	<form action="" method="POST">
    		...
    		<tr>
    			...
    			<td>
    				<input type="text" name="agency" pattern="[A-Za-z]+" title="Only Alphabets are allowed." required><span class="star">*</span>
    			</td>
    		</tr>
    		...
    		<tr>
    			...
    			<td>
    				<input type="text" name="fname" pattern="[A-Za-z]+" title="Only Alphabets are allowed." placeholder="First Name" required><span class="star">*</span>
    			</td>
    		</tr>
            ...
            <tr>
                ...
                <td>
                    <input type="text" name="mname" pattern="[A-Za-z]+" title="Only Alphabets are allowed." placeholder="Middle Name">
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                    <input type="text" name="lname" pattern="[A-Za-z]+" title="Only Alphabets are allowed." placeholder="Last Name" required><span class="star">*</span>
                </td>
            </tr>
