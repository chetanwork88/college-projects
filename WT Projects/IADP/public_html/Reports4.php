...
<!--Navbar-->
	...
	<div class="btnclass">
		<input type="button" id="backbtn" value="<< Back" onclick="location.href='Reports3.php'" title="Soil Testing details">
		<input type="button" id="homebtn" value="Home" onclick="location.href='Reports.php'" title="Report Home Page">
		<input type="button" id="nextbtn" value="Next >>" onclick="location.href='Reports5.php'" title="Dairy details">
	</div>


	<div class="repheading">4.Horticulture (Fruit Farms) Requirements Details</div>
		<hr/>
	...
	<div class="table-responsive">	
    	...
    	$sql="SELECT sr_no,aadhar_no,fname,mname,lname,contact1,address,village,taluka,district,horti_amt FROM details WHERE horti_help = 'Yes'";
