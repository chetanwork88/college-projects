...
<!--Navbar-->
	...
	<div class="btnclass">
		<input type="button" id="backbtn" value="<< Back" onclick="location.href='Reports11.php'" title="Scholarship details">
		<input type="button" id="homebtn" value="Home" onclick="location.href='Reports.php'" title="Report Home Page">
		<input type="button" id="nextbtn" value="Next >>" onclick="location.href='Reports21.php'" title="Employment details">
	</div>

		<div class="repheading"> 12.Higher Education Details </div>
	...
	<div class="table-responsive">	
    	...
    	$sql="SELECT sr_no,aadhar_no,fname,mname,lname,contact1,address,village,taluka,district,taking_edu1,edu_type1,taking_edu2,edu_type2,taking_edu3,edu_type3 FROM details where taking_edu1 !='-'";
