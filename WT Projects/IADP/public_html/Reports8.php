...
<!--Navbar-->
	...
	<div class="btnclass">
		<input type="button" id="backbtn" value="<< Back" onclick="location.href='Reports7.php'" title="Fishery details">
		<input type="button" id="homebtn" value="Home" onclick="location.href='Reports.php'" title="Report Home Page">
		<input type="button" id="nextbtn" value="Next >>" onclick="location.href='Reports9.php'" title="Modern Methods details">
	</div>


	<div class="repheading">8.Animal Husbandry Requirements Details</div>
		<hr/>
	...
	<div class="table-responsive">	
    	...
    	$sql="SELECT sr_no,aadhar_no,fname,mname,lname,contact1,address,village,taluka,district,ah_amt FROM details WHERE ah_help = 'Yes'";
