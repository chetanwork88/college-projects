...
<!--Navbar-->
	...
	<div class="btnclass">
		<input type="button" id="backbtn" value="<< Back" onclick="location.href='Reports4.php'" title="Horticulture details">
		<input type="button" id="homebtn" value="Home" onclick="location.href='Reports.php'" title="Report Home Page">
		<input type="button" id="nextbtn" value="Next >>" onclick="location.href='Reports6.php'" title="Poultry details">
	</div>


	<div class="repheading">5.Dairy Requirements Details</div>
		<hr/>
	...
	<div class="table-responsive">	
    	...
    	$sql="SELECT sr_no,aadhar_no,fname,mname,lname,contact1,address,village,taluka,district,dairy_amt FROM details WHERE dairy_help = 'Yes'";
