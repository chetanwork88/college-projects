...
<!--Navbar-->
	...
	<div class="btnclass">
		...
		<input type="button" id="nextbtn" value="Next >>" onclick="location.href='Reports2.php'" title="Village wise details">
	</div>

		<div class="repheading"> 1.Contact Details </div>
	...
	<div class="table-responsive">	
    	...
    	$sql="SELECT sr_no,aadhar_no,fname,mname,lname,contact1,address,village,taluka,district,state FROM details";
