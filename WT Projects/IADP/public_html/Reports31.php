...
<!--Navbar-->
	...
	<div class="btnclass">
		<input type="button" id="backbtn" value="<< Back" onclick="location.href='Reports22.php'" title="Self-Employment details">
		<input type="button" id="homebtn" value="Home" onclick="location.href='Reports.php'" title="Report Home Page">
		<input type="button" id="nextbtn" value="Next >>" onclick="location.href='Reports.php'" title="Report index Page">
	</div>

		<div class="repheading"> 31.Health-Care Details </div>
	...
	<div class="table-responsive">	
    	...
    	$sql="SELECT sr_no,aadhar_no,fname,mname,lname,contact1,address,village,taluka,district,health_help1,health_help2,health_help_type,health_help_cost FROM details";
		...
		if ($result->num_rows > 0) 
		{
			...
			<th>Tehsil</th>
			<th>District</th>
			<th>1.Beneficiary Relation</th>
			<th>2.Beneficiary Relation</th>
			<th>Help Type</th>
