		...
		<div class="loginform">
			...
			<form action="Login.php" method="post">
				<table>
					...
					<tr>
						<td><input type="text" class="form-control" name="lemail" minlength="10" maxlength="12"  placeholder="Enter Aadhar/Mobile Number." required></td>
					</tr>
...
<?php
$message = "Please login to fill the form..";
