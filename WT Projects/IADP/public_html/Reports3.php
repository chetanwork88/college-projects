...
<head>
  ...
  <script type="text/javascript" src="js/markcomplete.js"></script>
...
<!--Navbar-->
	...
	<div class="btnclass">
		<input type="button" id="backbtn" value="<< Back" onclick="location.href='Reports2.php'" title="village wise Details">
		<input type="button" id="homebtn" value="Home" onclick="location.href='Reports.php'" title="Report Home Page">
		<input type="button" id="nextbtn" value="Next >>" onclick="location.href='Reports4.php'" title="Horticulture Details">
	</div>

	<div class="repheading"> 3.Soil Testing Requirement Details </div>
		<hr/>
	...
	<div class="table-responsive">	
    	...
    	$sql="SELECT sr_no,aadhar_no,fname,mname,lname,contact1,address,village,taluka,district,state FROM details WHERE soil_tested = 'Yes'";
		...
		if ($result->num_rows > 0) 
		{
		    ...
		    {
		       /* echo"<a href='markcomplete.php?mark=true'>";*/
     			echo "<tr onclick='myFunction()'>";
				echo "<td class='sno'>" . $row['sr_no'] . "</td>";
