...
<!--Navbar-->
	...
	<div class="btnclass">
		<input type="button" id="backbtn" value="<< Back" onclick="location.href='Reports1.php'" title="contact Details">
		<input type="button" id="homebtn" value="Home" onclick="location.href='Reports.php'" title="Report Home Page">
		<input type="button" id="nextbtn" value="Next >>" onclick="location.href='Reports3.php'" title="Soil Testing details">
	</div>

		<div class="repheading"> 2.Village wise Details </div>
		<hr/>
		<div class="villoption">
		<a>1.Enter Village Name:</a><br>
			<div class="villinput">
				<form action="" method="post">
					<input type='text' name='vill'><br>
					<input type='submit' name='villsubmit' value='Search'><br>
				</form>
			</div>
			...
			<div class="table-responsive"> 
				...
				<?php
					...
					if(isset($_REQUEST['villsubmit']))
    				{
       				singlevillage(); 	
    				}

  					function singlevillage()
  					{
        ...
        $dbname = "iadpindi_iadp";
    				...
    				$sql="SELECT sr_no,village,aadhar_no,fname,mname,lname,contact1,address,taluka FROM details WHERE village='$svillage'";
		...
		<hr>
		<a href='Reports2.php?hello2="true"'>2.View complete List</a>
		</div>
	...
	<div class="table-responsive">	
		...
		// Check connection
    		...
    		$sql="SELECT sr_no,aadhar_no,fname,mname,lname,contact1,address,village,taluka FROM details";
