...
<!--Navbar-->
	...
	<div class="btnclass">
		<input type="button" id="backbtn" value="<< Back" onclick="location.href='Reports12.php'" title="Higher Education details">
		<input type="button" id="homebtn" value="Home" onclick="location.href='Reports.php'" title="Report Home Page">
		<input type="button" id="nextbtn" value="Next >>" onclick="location.href='Reports22.php'" title="Self-Employment details">
	</div>

		<div class="repheading"> 21.Job Seekers Details </div>
	...
	<div class="table-responsive">	
    	...
    	$sql="SELECT sr_no,aadhar_no,fname,mname,lname,contact1,address,village,taluka,district,need_job1,job_needy_edu1,need_job2,job_needy_edu2 FROM details WHERE need_job1 IS NOT NULL";
		...
		if ($result->num_rows > 0) 
		{
			...
			<th>Tehsil</th>
			<th>District</th>
			<th>1.Job Seeker Relation</th>
			<th>Job Seeker Education</th>
			<th>2.Job Seeker Relation</th>
			<th>Job Seeker Education</th>
			</tr>";
