...
<!--Navbar-->
	...
	<div class="btnclass">
		<input type="button" id="backbtn" value="<< Back" onclick="location.href='Reports21.php'" title="Job Seekers details">
		<input type="button" id="homebtn" value="Home" onclick="location.href='Reports.php'" title="Report Home Page">
		<input type="button" id="nextbtn" value="Next >>" onclick="location.href='Reports31.php'" title="Health details">
	</div>

		<div class="repheading"> 22.Self-Employment Details </div>
	...
	<div class="table-responsive">	
    	...
    	$sql="SELECT sr_no,aadhar_no,fname,mname,lname,contact1,address,village,taluka,district,which_selfb,	selfb_help_type,selfb_invest,return_policy FROM details WHERE need_selfb='Yes'";
		...
		if ($result->num_rows > 0) 
		{
			...
			<th>Business-help Type</th>
			<th>Expected Investment</th>
			<th>Return Policy<br>(per month)</th>
			</tr>";
